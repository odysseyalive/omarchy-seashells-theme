...
### neovim.lua
- INC-2025-12-24-lazyvim-tab-bar — LazyVim tab bar transparency fix (resolved)
...
### walker.css
- INC-2025-10-24-menu-transparency — Walker menu transparency fix (resolved)
- PAT-2026-02-26-clarity-iteration — Light theme requires multiple clarity iterations (active)

### setup
- INC-2025-10-24-duplicate-bg-downloads — Duplicate background downloads (resolved)
- INC-2025-12-24-light-mode-setup — light.mode downloaded for wrong theme (resolved)

### compatibility
- DEC-2025-10-25-standardized-settings — Minimal color-only overrides for Omarchy (accepted)
...
### Active
- PAT-2026-02-26-clarity-iteration — Light theme color clarity requires iteration [seashells-light, color-tuning]
- PAT-2026-02-26-shared-accent-color — Ocean cyan #50a3b5 shared between themes [accent-color, both-themes]
...
- INC-2025-10-24-duplicate-bg-downloads — Setup script duplicate downloads [setup]
- INC-2025-12-24-light-mode-setup — light.mode marker file downloaded for both themes [setup]
